# Doc Highlighter — Local HTML & Markdown · v0.8.0
...
şemasında `$İSİM# Doc Highlighter — Local HTML & Markdown · v0.8.0
 ...
 **rezerve** bir sözdizimidir: bir mesajda geçiyorsa aynı mesajda bir
...
reddetti**. Çözüm: `# Doc Highlighter — Local HTML & Markdown · v0.8.0
...
olarak yakalar.
 ...
 sözdiziminden çıkıp `{n}` gibi nötr bir token kullanmak
